    ...
    <div style="margin: 8px auto; display: block; text-align:center;">
	 ...
	 <section class="list_home">
        ...
        <div class="workinghny-form-grid">
            ...
            include 'config.php';
            $quer="Select * from interview_schedule ORDER BY StartTime DESC";
            ...
            <tr>
                ...
                <td><a href="/files/delete.php?id=<?php echo $row['id']; ?>"><button style="background-color:red; onclick = delete(<?php echo $row['id']; ?>); border:none;  padding: 4px; color:#fff;"><i class="fa fa-trash" aria-hidden="true"></i>Delete</button></a></td>
                <td><a href="/files/resume/<?php echo $row['resume_loc']; ?>" target="_blank"><button style="background-color:#f04f1f; onclick = delete(<?php echo $row['id']; ?>); border:none;  padding: 4px; color:#fff;"><i class="fa fa-file" aria-hidden="true"></i>View Resume</button></a></td>
            </tr>
            <?php
                }
             ?>
