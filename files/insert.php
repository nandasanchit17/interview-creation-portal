...
<head>
	<title>InterviewX - Schedule</title>
 ...
 <header>
	 ...
	 <section class="list_home">
        <!-- /form -->
            ...
            <div class="wrapper">
                <div class="logo">
                    <h1>Schedule an Interview</a></h1>
                   
                </div>
        <div class="workinghny-form-grid">
            <div class="wrapper">
            <div class="form-group">
            <form method="post" action="/files/add.php" enctype='multipart/form-data'>
                <label for="interview Title" class="color-blue-dark font-12">Interview Title</label>
                <input type="text" name="InterviewTitle" placeholder="What is this meeting for?" required>
                <br>
                
                <label for="participant" class="color-blue-dark font-12">Select Participants</label>
                <select name="ListOfPeopleC[]" id="ListOfPeopleC" required value="" multiple class="multiple-select" placeholder="Select two or more participants from the given options.">
                ...
                <label for="time_start" class="color-blue-dark font-12">Choose a Starting Date and Time</label>
               <input type="datetime-local" id="StartDateTime" name="StartDateTime" required>
                <br>
                
                <label for="time_end" class="color-blue-dark font-12">Choose an Ending Date and Time</label>
                ...
                <center>
                <input type="submit" value="Schedule Interview" name="submit" style="background-color:#f04f1f; color:#fff; border:none; cursor: pointer;">
                </center>
